              ...
              <Grid item xs={12} sm={4}>
                ...
                >
                  ...
                  <Select
                    ...
                    label="Emirate"
                    onChange={(e) =>
                      handleChange("emirate", "correspondenceAddress", e.target.value)
                    }
                  >
                    {emirates.map((emirate) => (
                      <MenuItem key={emirate} value={emirate}>
                  ...
                  {errors?.correspondenceAddress?.emirate && (
                    <FormHelperText>{errors.correspondenceAddress.emirate}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              <Grid item xs={12} sm={4}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={4}>
                ...
                <TextField
                  ...
                  value={contactDetails.residenceAddress.flatVillaNo}
                  onChange={(e) =>
                    handleChange("flatVillaNo", "residenceAddress", e.target.value)
                  }
                />
              </Grid>
